...
USERNAME = environ.get('USERNAME', "https://telegram.me/isPelo")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002363820788'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+zP5SFl_CagczZTZl')
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002325366768')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002432817906'))
...
PROVIDED_BY= environ.get('PROVIDED_BY', f'{script.PROVIDED_BY}')
